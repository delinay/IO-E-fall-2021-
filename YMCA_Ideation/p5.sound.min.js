! function (t, e) {
    ...
    a = function (e) {
        var i = function () {
                this.input = e.createGain(), this.output = e.createGain(), this.limiter = e.createDynamicsCompressor(), this.limiter.threshold.value = -3, this.limiter.ratio.value = 20, this.limiter.knee.value = 1, this.audiocontext = e, this.output.disconnect(), this.input.connect(this.limiter), this.limiter.connect(this.output), this.meter = e.createGain(), this.fftMeter = e.createGain(), this.output.connect(this.meter), this.output.connect(this.fftMeter), this.output.connect(this.audiocontext.destination), this.soundArray = [], this.parts = [], this.extensions = []
            },
            n = new i;
        return t.prototype.getMasterVolume = function () {
            ...
            if ("number" == typeof t) {
                ...
                n.output.gain.cancelScheduledValues(o + i), n.output.gain.linearRampToValueAtTime(r, o + i), n.output.gain.linearRampToValueAtTime(t, o + i + e)
            } else {
                if (!t) return n.output.gain;
    ...
    u = function () {
        function e(t) {
            var e, r;
            e = t.getChannelData(0), r = t.numberOfChannels > 1 ? t.getChannelData(1) : e;
            var s = i(e, r),
                a = new window.ArrayBuffer(44 + 2 * s.length),
                u = new window.DataView(a);
            n(u, 0, "RIFF"), u.setUint32(4, 36 + 2 * s.length, !0), n(u, 8, "WAVE"), n(u, 12, "fmt "), u.setUint32(16, 16, !0), u.setUint16(20, 1, !0), u.setUint16(22, 2, !0), u.setUint32(24, o.audiocontext.sampleRate, !0), u.setUint32(28, 4 * o.audiocontext.sampleRate, !0), u.setUint16(32, 4, !0), u.setUint16(34, 16, !0), n(u, 36, "data"), u.setUint32(40, 2 * s.length, !0);
            for (var c = s.length, p = 44, h = 1, l = 0; c > l; l++) u.setInt16(p, s[l] * (32767 * h), !0), p += 2;
            return u
        }
        ...
        return t.prototype.soundFormats = function () {
            ...
            for (var t = 0; t < o.soundArray.length; t++) o.soundArray[t].dispose()
    ...
    h = function () {
        ...
        function o(t, e, i, n) {
            for (var o = [], s = Object.keys(t).sort(), a = 0; a < s.length; a++)
                for (var u = s[a], c = t[u], p = 0; p < c.intervals.length; p++) {
                    ...
                    h = r(h), Math.abs(h - e) < n && o.push(c.sampleIndex / i)
                }
        ...
        function s(t) {
            ...
            this._lastPos = e[e.length - 1] || 0, this._onTimeUpdate(self._lastPos)
        }

        function p(t) {
            const e = t.target,
                i = this;
            e._playing = !1, e.removeEventListener("ended", i._clearOnEnd), i._onended(i), i.bufferSourceNodes.forEach(function (t, e) {
        ...
        t.SoundFile = function (e, i, n, o) {
            ...
            var r, s, a = l.audiocontext.currentTime,
                u = t || 0;
            if (0 > u && (u = 0), u += a, "undefined" != typeof e && this.rate(e), "undefined" != typeof i && this.setVolume(i), !this.buffer) throw "not ready to play file, buffer has yet to load. Try preload()";
        ...
        t.SoundFile.prototype._initCounterNode = function () {
            ...
            g.type = "lowpass", v.connect(g), g.connect(y.destination), v.start(0), y.startRendering(), y.oncomplete = function (r) {
                if (self.panner) {
                    ...
                    do h = e(a, f), f -= .005; while (Object.keys(h).length < m && f >= d);
                    var u = i(h),
                        c = n(u, s.sampleRate),
    ...
    f = function () {
        ...
        t.FFT = function (t, i) {
            ...
            for (var e, i, n, s = 0; s < arguments.length; s++) "number" == typeof arguments[s] && (e = arguments[s], this.analyser.fftSize = 2 * e), "string" == typeof arguments[s] && (i = arguments[s]);
            if (i && !t.prototype._isSafari()) return o(this, this.timeDomain), this.analyser.getFloatTimeDomainData(this.timeDomain), this.timeDomain;
            r(this, this.timeDomain), this.analyser.getByteTimeDomainData(this.timeDomain);
            ...
            n(this, this.freqDomain), this.analyser.getByteFrequencyData(this.freqDomain);
    ...
    k = function () {
        ...
        t.Signal = function (t) {
            var i = new e(t);
            return i
        }, e.prototype.fade = e.prototype.linearRampToValueAtTime, n.prototype.fade = e.prototype.fade, i.prototype.fade = e.prototype.fade, o.prototype.fade = e.prototype.fade, e.prototype.setInput = function (t) {
            t.connect(this)
        }, n.prototype.setInput = e.prototype.setInput, i.prototype.setInput = e.prototype.setInput, o.prototype.setInput = e.prototype.setInput, e.prototype.add = function (t) {
            var e = new i(t);
            return this.connect(e), e
        }, n.prototype.add = e.prototype.add, i.prototype.add = e.prototype.add, o.prototype.add = e.prototype.add, e.prototype.mult = function (t) {
            var e = new n(t);
            return this.connect(e), e
        }, n.prototype.mult = e.prototype.mult, i.prototype.mult = e.prototype.mult, o.prototype.mult = e.prototype.mult, e.prototype.scale = function (e, i, n, r) {
            var s, a;
        ...
        }, n.prototype.scale = e.prototype.scale, i.prototype.scale = e.prototype.scale, o.prototype.scale = e.prototype.scale
    }(S, w, A, P);
    var O;
    O = function () {
        var e = a,
    ...
    M = function () {
        ...
        t.Envelope = function (t, i, n, o, s, a) {
            this.aTime = t || .1, this.aLevel = i || 1, this.dTime = n || .5, this.dLevel = o || 0, this.rTime = s || 0, this.rLevel = a || 0, this._rampHighPercentage = .98, this._rampLowPercentage = .02, this.output = e.audiocontext.createGain(), this.control = new r, this._init(), this.control.connect(this.output), this.connection = null, this.mathOps = [this.control], this.isExponential = !1, this.sourceToClear = null, this.wasTriggered = !1, e.soundArray.push(this)
    ...
    V = function () {
        ...
        t.Noise = function (e) {
            var r;
            t.Oscillator.call(this), delete this.f, delete this.freq, delete this.oscillator, r = "brown" === e ? o : "pink" === e ? n : i, this.buffer = r
    ...
    K = function () {
        var e = c,
            i = Y;
        t.Reverb = function () {
            i.call(this), this._initConvolverNode(), this.input.gain.value = .5, this._seconds = 3, this._decay = 2, this._reverse = !1, this._buildImpulse()
        }, t.Reverb.prototype = Object.create(i.prototype), t.Reverb.prototype._initConvolverNode = function () {
            ...
            t.Reverb.call(this), this._initConvolverNode(), this.input.gain.value = .5, e ? (this.impulses = [], this._loadBuffer(e, i, n)) : (this._seconds = 3, this._decay = 2, this._reverse = !1, this._buildImpulse())
            ...
            u.open("GET", i, !0), u.responseType = "arraybuffer", u.onload = function () {
                if (200 === u.status) a.decodeAudioData(u.response, function (t) {
                    var e = {},
                        o = i.split("/");
                    e.name = o[o.length - 1], e.audioBuffer = t, r.impulses.push(e), r._setBuffer(e.audioBuffer), n && n(e)
                }, function () {
            ...
            for (var e in this.impulses) this.impulses[e] && (this.impulses[e] = null)
        }
    }(c, Y);
    var tt;
    tt = function (t) {
    ...
    nt = function () {
        ...
        t.prototype.setBPM = function (t, e) {
            ...
            this.length = e || 0, this.partStep = 0,
                this.phrases = [], this.isPlaying = !1, this.noLoop(), this.tatums = o || .0625, this.metro = new t.Metro, this.metro._init(), this.metro.beatLength(this.tatums), this.metro.setBPM(n), i.parts.push(this), this.callback = function () {}
    ...
    st = function () {
        ...
        t.SoundRecorder = function () {
            this.input = n.createGain(), this.output = n.createGain(), this.recording = !1, this.bufferSize = 1024, this._channels = 2, this._clear(), this._jsNode = n.createScriptProcessor(this.bufferSize, this._channels, 2), this._jsNode.onaudioprocess = this._audioprocess.bind(this), this._callback = function () {}, this._jsNode.connect(t.soundOut._silentNode), this.setInput(), e.soundArray.push(this)
        }, t.SoundRecorder.prototype.setInput = function (e) {
            this.input.disconnect(), this.input = null, this.input = n.createGain(), this.input.connect(this._jsNode), this.input.connect(this.output), e ? e.connect(this.input) : t.soundOut.output.connect(this.input)
        }, t.SoundRecorder.prototype.record = function (t, e, i) {
            this.recording = !0, e && (this.sampleLimit = Math.round(e * n.sampleRate)), t && i ? this._callback = function () {
            ...
            this._clear();
            var t = e.soundArray.indexOf(this);
            e.soundArray.splice(t, 1), this._callback = function () {}, this.input && this.input.disconnect(), this.input = null, this._jsNode = null
    ...
    pt = function () {
        ...
        t.MonoSynth = function () {
            ...
            i.prototype.dispose.apply(this), this.env && this.env.dispose(), this.oscillator && this.oscillator.dispose()
        }
    }(a, ct, u);
    var ht;
    ht = function () {
        ...
        t.PolySynth = function (n, o) {
            ...
            if (t) {
                ...
                if (this.notes[a] && null !== this.notes[a].getValueAtTime(s)) {
                    ...
                    this._voicesInUse.setValueAtTime(u - 1, s), u > 0 && this._updateAfter(s, -1), this.audiovoices[this.notes[a].getValueAtTime(s)].triggerRelease(r), this.notes[a].dispose(), delete this.notes[a], this._newest = 0 === this._newest ? 0 : (this._newest - 1) % (this.maxVoices - 1)
