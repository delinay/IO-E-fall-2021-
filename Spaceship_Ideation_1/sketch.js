...
function draw() {
    ...
    text(latestData, 30, 50);
    ellipseMode(RADIUS);
    fill(128, 170, 255);
    noStroke();
    //console.log("diameter0  "  + diameter0);
    ellipse(100, 100, diameter2 * 100, diameter2 * 100);
    ellipseMode(RADIUS);
    fill(0, 0, 0);
    ellipse(diameter1, 100, 500, 50);


    fill(0);
    textSize(40);
    textAlign(CENTER);
    text("Spaceship! Incoming! Oh no...Aliens?!?", windowWidth / 2, windowHeight / 2);



    var freq = map(diameter0, 100, width, 40, 880);
    osc1.freq(freq);
    //console.log(freq);
